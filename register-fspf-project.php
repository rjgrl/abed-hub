...
$stmt = $conn->prepare("SELECT id FROM fspf_projects WHERE project_code = ?");
...
if ($stmt->execute()) {
    ...
    logAudit('CREATE_FSPF_PROJECT', 'FSPF', $project_id, null, $_POST);
    
    echo json_encode([
        'status' => 'success',
        'message' => 'FSPF Project registered successfully',
