...
$districtVal = trim((string) ($project['district'] ?? ''));
$html .= '<tr><th>Barangay</th><td>' . $safe($project['barangay'] ?? '-') . '</td><th>Purok</th><td>' . $safe($districtVal !== '' ? $districtVal : '-') . '</td></tr>';
$html .= '<tr><th>Description</th><td colspan="3">' . $safe($project['description'] ?? '-') . '</td></tr>';
